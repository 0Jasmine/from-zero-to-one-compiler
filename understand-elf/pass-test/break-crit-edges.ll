...
7:                                                ; preds = %11
  ...
  br i1 %10, label %19, label %._crit_edge, !llvm.loop !5

._crit_edge:                                      ; preds = %7
  br label %1

11:                                               ; preds = %._crit_edge1, %1
  %12 = phi i32 [ 0, %1 ], [ %17, %._crit_edge1 ]
  ...
  br i1 %18, label %7, label %._crit_edge1, !llvm.loop !7
